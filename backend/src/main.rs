...
async fn main() -> Result<(), anyhow::Error> {
    ...
    let state = AppState {
        ...
        withdrawal_fee_buffer_sats: config.withdrawal_fee_buffer_sats,
        single_request_cap_ratio: config.single_request_cap_ratio,
        pending_deposit_ttl_secs: config.pending_deposit_ttl_secs,
        max_pending_deposits_per_session: config.max_pending_deposits_per_session,
